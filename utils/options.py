...
def args_parser():
    ...
    parser.add_argument('--cuda_device', type=str, default="4", help="cuda_device")
    parser.add_argument('--imshow', type=bool, default=False, help="show some training dataset")
    parser.add_argument('--model', type=str, default='trans_shuf', help='model name')
    ...
    parser.add_argument('--shuf_type', type=str, default="shuf_liteconv", help='')
    parser.add_argument('--train_img', type=str, default='/home/zengweijia/dataset/PKLot/PKLotSegmented',
                        help="path to training set images")
    parser.add_argument('--train_lab', type=str, default='/home/zengweijia/dataset/splits/PKLot/train_36.txt',
                        help="path to training set labels")
    parser.add_argument('--test_img', type=str, default='/home/zengweijia/dataset/PATCHES',
                        help="path to test set images")
    parser.add_argument('--test_lab', type=str, default='/home/zengweijia/dataset/splits/CNRPark-EXT/all.txt',
