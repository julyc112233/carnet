...
def args_parser():
    ...
    parser.add_argument('--model', type=str, default='stn_shuf', help='model name')
    ...
    parser.add_argument('--test_img', type=str, default='/home/zengweijia/.jupyter/cnrpark/PKLot/PKLotSegmented',
                        help="path to test set images")
    parser.add_argument('--test_lab', type=str, default='/home/zengweijia/.jupyter/cnrpark/splits/PKLot/val.txt',
    ...
    parser.add_argument('--split_path', type=str, default='/Users/julyc/PycharmProjects/parking_lot_occupancy_detection/data/stn_shuf',
                        help="path to training set labels")
